...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Share+Tech+Mono&weight=600&size=20&duration=2500&pause=800&color=00C9A7&center=true&vCenter=true&multiline=true&width=700&height=100&lines=CAD+Engineer+%40+AtherStrike+%E2%80%94+F1+in+Schools;Web+Dev+%C2%B7+3D+Design+%C2%B7+Cybersecurity;Amity+International%2C+Gurugram;Building+a+regulation+F1+car+for+nationals)](https://git.io/typing-svg)
...
const AaravSinghal = () => {
  ...
  return (
    <div className="dev-card">
      ...
      {tab === "profile" && <ProfileView data={profile} />}
      {tab === "fun"     && <Toast message={funFact()} />}
    </div>
  );
};

export default AaravSinghal;
```
